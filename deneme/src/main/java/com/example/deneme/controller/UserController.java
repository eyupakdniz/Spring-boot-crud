...
import com.example.deneme.shared.GenericResponse;
...
public class UserController {
	...
	public ResponseEntity<?> createUser(@RequestBody UserCreateDTO userCreateDTO){
		...
		return ResponseEntity.ok(new GenericResponse("User Oluşturuldu."));
	}
	...
	public ResponseEntity<?> deleteUser(@PathVariable("id") Long id){
		...
		return ResponseEntity.ok(new GenericResponse("eleman silindi!"));
	}
